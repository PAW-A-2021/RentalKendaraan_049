...
namespace RentalKendaraan.Controllers
{
    public class PengembaliansController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IdPeminjaman"] = new SelectList(_context.Peminjamen, "IdPeminjamaan", "IdPeminjamaan");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPengembalian,TglPengembalian,IdPeminjaman,IdKondisi,Denda")] Pengembalian pengembalian)
        {
            ...
            ViewData["IdPeminjaman"] = new SelectList(_context.Peminjamen, "IdPeminjamaan", "IdPeminjamaan", pengembalian.IdPeminjaman);
            return View(pengembalian);
        }
